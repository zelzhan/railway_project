...
public class RailwayService extends HttpServlet {
    ...
    public Response userProfile(@FormParam("authToken") String authToken, @Context HttpHeaders headers) {
    ...
    @Path("buyTicket")
    public Response postNewTickets(String js, @Context HttpHeaders headers, ContainerRequestContext requestContext) {
        String authToken = getTokenFromHeader(requestContext);
        String email = getEmailFromToken(authToken);
        makeLog(headers,"Passenger with email " + email, "POST");
    ...
    @POST
    @Path("cancelTicket")
    public Response cancelTicket(@QueryParam("ticket_id") int ticket_id, ContainerRequestContext requestContext, @Context HttpHeaders headers){
