...
public class AgentService extends HttpServlet {
    ...
    public Response agentProfile(ContainerRequestContext requestContext, @Context HttpHeaders headers) {
        ...
        makeLog(headers,"Agent with email "+email, "POST");
    ...
    @Path("buyTicketAgent")
    public Response agentNewTickets(String js, ContainerRequestContext requestContext, @Context HttpHeaders headers) {
        Gson gson  = new Gson();
